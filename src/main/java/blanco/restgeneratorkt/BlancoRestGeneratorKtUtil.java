...
public class BlancoRestGeneratorKtUtil {
    ...
    public void process(final BlancoRestGeneratorKtProcessInput input) throws IOException {
        if (this.isVerbose()) {
            System.out.println("BlancoRestGeneratorKtObjectsInfo : process start !");
        }
            ...
            if (structures != null ) {
                for (int index2 = 0; index2 < structures.length; index2++) {
                    ...
                    if (structure != null) {
                        ...
                        System.out.println("BlancoRestGeneratorKtObjectsInfo: a structure is NULL!!!");
                    }
                }
            } else {
                System.out.println("BlancoRestGeneratorKtObjectsInfo: structures are NULL!!!");
            }
        }
    }
