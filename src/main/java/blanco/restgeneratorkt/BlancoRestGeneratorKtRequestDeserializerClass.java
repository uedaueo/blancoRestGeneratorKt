...
public class BlancoRestGeneratorKtRequestDeserializerClass {
    ...
    private String fDeserializerCommonRequest = null;
    ...
    public BlancoRestGeneratorKtRequestDeserializerClass(
            ...
            final String argDeserializerCommonRequest,
    ...
    public BlancoCgSourceFile expand() {
        ...
        String deserializerCommonRequest = fTelegrampackage + ".CommonRequest";
        if (!BlancoStringUtil.null2Blank(fDeserializerCommonRequest).isEmpty()) {
            deserializerCommonRequest = fDeserializerCommonRequest;
        }
        stdDeserializer.setGenerics(deserializerCommonRequest + "<S, T>");
    ...
    private BlancoCgMethod buildDeserializeMethod() {
        ...
        BlancoCgReturn cgReturn = fCgFactory.createReturn(deserializerCommonRequest, "Parses JSON, packs it into a CommonRequest, and returns it.");
        ...
        lineList.add("var retval: " + deserializerCommonRequest +"<S, T>? = null");
        lineList.add("if (info != null) {");
        lineList.add("retval = " + deserializerCommonRequest + "<S, T>(info, telegram)");
        lineList.add("}");
