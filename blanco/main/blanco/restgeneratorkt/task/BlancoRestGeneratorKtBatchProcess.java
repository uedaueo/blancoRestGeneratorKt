...
public class BlancoRestGeneratorKtBatchProcess {
    ...
    public static final void usage() {
        ...
        System.out.println("  java blanco.restgeneratorkt.task.BlancoRestGeneratorKtBatchProcess -verbose=値1 -metadir=値2 -targetdir=値3 -tmpdir=値4 -nameAdjust=値5 -encoding=値6 -tabs=値7 -xmlrootelement=値8 -sheetType=値9 -targetStyle=値10 -client=値11");
