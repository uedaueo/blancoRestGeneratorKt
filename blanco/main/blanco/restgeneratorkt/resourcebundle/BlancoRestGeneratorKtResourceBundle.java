...
public class BlancoRestGeneratorKtResourceBundle {
    ...
    /**
     * bundle[BlancoRestGeneratorKt], key[XML2SOURCE_FILE.TELEGRAM.GENERATOR.DESCRIPTION]
     *
    ...
    /**
     * bundle[BlancoRestGeneratorKt], key[XML2SOURCE_FILE.TELEGRAM.GENERATOR.RETURN.DESCRIPTION]
     *
    ...
    /**
     * bundle[BlancoRestGeneratorKt], key[XML2SOURCE_FILE.TELEGRAM.GENERATOR.FACTORY.DESCRIPTION]
     *
    ...
    /**
     * bundle[BlancoRestGeneratorKt], key[XML2SOURCE_FILE.TELEGRAM.GENERATOR.FACTORY.ARG.METHOD.DESCRIPTION]
     *
     * [生成対象のメソッドです] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoRestGeneratorKt], key[XML2SOURCE_FILE.TELEGRAM.GENERATOR.FACTORY.RETURN.DESCRIPTION]
     *
     ...
     *
     * [blancoRestGeneratorKtのデフォルト例外の定義です.] (ja)<br>
     *
    ...
    public String getXml2sourceFileDefaultExceptionTypeLangdoc() {
        // 初期値として定義書の値を利用します。
        String strFormat = "blancoRestGeneratorKtのデフォルト例外の定義です.";
        try {
            if (fResourceBundle != null) {
     ...
     *
     * [blancoRestGeneratorKtのデフォルト例外です.] (ja)<br>
     *
    ...
    public String getXml2sourceFileDefaultExceptionLangdoc() {
        // 初期値として定義書の値を利用します。
        String strFormat = "blancoRestGeneratorKtのデフォルト例外です.";
        try {
            if (fResourceBundle != null) {
